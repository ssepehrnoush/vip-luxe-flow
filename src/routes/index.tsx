            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-sm sm:text-base text-muted-foreground max-w-md mx-auto leading-relaxed">
                  برای شروع، با حساب گوگل خود وارد شوید تا اطلاعات شما ذخیره شود و در مراجعات بعدی نیازی به تکرار مراحل نباشد.
                </p>
              </div>
              ...
              <button
                ...
                disabled={signingIn}
                className="glass rounded-2xl py-4 px-6 inline-flex items-center justify-center gap-3 font-bold hover:scale-[1.02] transition disabled:opacity-50 mx-auto shadow-lg"
              >
                {signingIn ? (
              ...
              <p className="text-[11px] text-muted-foreground mt-6">
                حساب گوگل شما فقط برای حفظ پیشرفت استفاده می‌شود
              </p>
            </motion.section>
          )}
